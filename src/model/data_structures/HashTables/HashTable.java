...
public class HashTable<K , V>
{
     ...
     */
    public static final int TAM_TABLA_HASHING = 321374+585;
	...
	private LinkedList<V> listValues;
	
	private LinkedList<K> listKeys;
	//--------------------------------------------------------
	//Constructores
	//--------------------------------------------------------
	...
	public HashTable() {
		...
		loadFactor = 0.95;
		listValues = new LinkedList<V>();
		listKeys = new LinkedList<K>();
	}
	...
	public LinkedList<V> valuesIterator(){
		return listValues;
	}
	
	public LinkedList<K> keysIterator2(){
