...
public class MSTOnLargestComponent {
    ...
    public MSTOnLargestComponent(Graph G, Comparator comp) throws UnexistingVertexException {
        CC cc = new CC(G);
       ...
       inComponent = new HashTable<>(4);
        ...
        MST = new KruskalMST(G, comp, max, inComponent, numVertices);
